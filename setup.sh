...
echo "  4. This script sets up the Monitor path only, and Claude Code 2.1.274 made a Monitor"
echo "     expire every 30 minutes. For messages pushed into the session instead, run"
echo "     'python3 setup.py install' and follow the steps it prints (trio shell-init)."
echo ""
